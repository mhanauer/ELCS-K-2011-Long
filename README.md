...
data1 = cbind( X1PRNCON= data1$X1PRNCON, X1PRNSOC=  data1$X1PRNSOC, X1PRNSAD = data1$X1PRNSAD, X1PRNIMP= data1$X1PRNIMP,  X1PRNAPP= data1$X1PRNAPP, X1TCHPER = data1$X1TCHPER, X1TCHEXT= data1$X1TCHEXT, X1TCHINT = data1$X1TCHINT, X1ATTNFS = data1$X1ATTNFS, X1INBCNT= data1$X1INBCNT, city = city, suburb = suburb, rural = rural, public = public, X1RESREL = data2$X1RESREL, X1HPARNT = data2$X1HPARNT, X1LANGST= data2$X1LANGST, data1$X1HPARNT, data1$X1PAR1AGE, X1PAR1RAC = parrace, X1HTOTAL = data1$X1HTOTAL, X1KAGE_R = data1$X1KAGE_R, X1PAR1ED_I = data1$X1PAR1ED_I)
dim(data1)
