...
Changed race to represent white
...
data2 = cbind(X1RESREL = data1$X1RESREL, X1HPARNT = data1$X1HPARNT)
data2 = ifelse(data2 == 1, 1, 0)
data2 = as.data.frame(data2)
head(data2)

# This is for lang change

X1LANGST =data1$X1LANGST
X1LANGST = ifelse(X1LANGST == 1,0,1)
names(X1LANGST) = c("X1LANGST")
X1LANGST = as.data.frame(X1LANGST)

# This is seperate, X1PAR1RAC

X1PAR1RAC = ifelse(data1$X1PAR1RAC == 1,1,0)
names(X1PAR1RAC) = c("X1PAR1RAC")
X1PAR1RAC = as.data.frame(X1PAR1RAC)


data1 = cbind( X1PRNCON= data1$X1PRNCON, X1PRNSOC=  data1$X1PRNSOC, X1PRNSAD = data1$X1PRNSAD, X1PRNIMP= data1$X1PRNIMP,  X1PRNAPP= data1$X1PRNAPP, X1TCHPER = data1$X1TCHPER, X1TCHEXT= data1$X1TCHEXT, X1TCHINT = data1$X1TCHINT, X1ATTNFS = data1$X1ATTNFS, X1INBCNT= data1$X1INBCNT, city = city, suburb = suburb, rural = rural, public = public, X1RESREL = data2$X1RESREL, X1HPARNT = data2$X1HPARNT, X1LANGST= X1LANGST, X1PAR1AGE =  data1$X1PAR1AGE, X1PAR1RAC = X1PAR1RAC, X1HTOTAL = data1$X1HTOTAL, X1KAGE_R = data1$X1KAGE_R, X1PAR1ED_I = data1$X1PAR1ED_I, time = data1$time)
data1 = as.data.frame(data1)
head(data1)

data2 = cbind(X1RESREL = data1$X1RESREL, X1HPARNT = data1$X1HPARNT, X1PAR1AGE = data1$X1PAR1AGE, X1PAR1RAC = data1$X1PAR1RAC, X1PAR1ED_I = data1$X1PAR1ED_I, X1HTOTAL = data1$X1HTOTAL, X1LANGST = data1$X1LANGST, X1KAGE_R = data1$X1KAGE_R, time = data1$time, X1PRNCON = data1$X1PRNCON, X1PRNSOC=  data1$X1PRNSOC,X1PRNSAD = data1$X1PRNSAD, X1PRNIMP= data1$X1PRNIMP,  X1PRNAPP= data1$X1PRNAPP)
...
vamDataInd = groupedData(X1PRNCON ~ X1PAR1AGE |time, data = data2)
head(vamDataInd)

unconVamData = lme(X1PRNCON ~ X1RESREL+ X1HPARNT+ X1LANGST +  X1PAR1AGE + X1PAR1RAC +X1HTOTAL + X1KAGE_R + X1PAR1ED_I , random =~ X1RESREL+ X1HPARNT+ X1LANGST +  X1PAR1AGE + X1PAR1RAC +X1HTOTAL + X1KAGE_R + X1PAR1ED_I | time, data = vamDataInd)
summary(unconVamData)
ranef(unconVamData, level = 1)[1:3,]

# This works
unconVamData = lme(X1PRNCON ~ X1PAR1AGE+ X1PAR1ED_I+ X1LANGST + X1HTOTAL, random =~ X1PAR1AGE+ X1PAR1ED_I+ X1LANGST + X1HTOTAL  | time, data = vamDataInd, method = "ML")
summary(unconVamData)
ranef(unconVamData, level = 1)[1:3,]

summary(modelX1PRNSOC)
ranef(modelX1PRNSOC, level = 1)[1:3,]
```
...
head(myData)
xName = "X1RESREL" ; x2Name = "X1HPARNT"; x3Name = "X1LANGST"; x4Name = "X1PAR1AGE"; x5Name = "X1PAR1RAC"; x6Name = "X1HTOTAL"; x7Name = "X1KAGE_R"; x8Name = "X1PAR1ED_I"; yName = "X1PRNCON" ; sName="time"
fileNameRoot = "Long1-" 
...
```
Now we have a model for the SI variable X1PRNSOC
```{r}
# Example for Jags-Ymet-XmetSsubj-MrobustHier.R 
#------------------------------------------------------------------------------- 
# Optional generic preliminaries:
...
myData = read.csv(file="ECLSK-2011-Long.csv")
head(myData)
xName = "X1RESREL" ; x2Name = "X1HPARNT"; x3Name = "X1LANGST"; x4Name = "X1PAR1AGE"; x5Name = "X1PAR1RAC"; x6Name = "X1HTOTAL"; x7Name = "X1KAGE_R"; x8Name = "X1PAR1ED_I"; yName = "X1PRNSOC" ; sName="time"
fileNameRoot = "Long2-" 
...
Now we have a model for the SL variable X1PRNSAD
```{r}
# Example for Jags-Ymet-XmetSsubj-MrobustHier.R 
#------------------------------------------------------------------------------- 
# Optional generic preliminaries:
...
myData = read.csv(file="ECLSK-2011-Long.csv")
head(myData)
xName = "X1RESREL" ; x2Name = "X1HPARNT"; x3Name = "X1LANGST"; x4Name = "X1PAR1AGE"; x5Name = "X1PAR1RAC"; x6Name = "X1HTOTAL"; x7Name = "X1KAGE_R"; x8Name = "X1PAR1ED_I"; yName = "X1PRNSAD" ; sName="time"
fileNameRoot = "Long3-" 
...
Now we have a model for the Impulsive Overactive variable X1PRNIMP
```{r}
# Example for Jags-Ymet-XmetSsubj-MrobustHier.R 
#------------------------------------------------------------------------------- 
# Optional generic preliminaries:
...
myData = read.csv(file="ECLSK-2011-Long.csv")
head(myData)
xName = "X1RESREL" ; x2Name = "X1HPARNT"; x3Name = "X1LANGST"; x4Name = "X1PAR1AGE"; x5Name = "X1PAR1RAC"; x6Name = "X1HTOTAL"; x7Name = "X1KAGE_R"; x8Name = "X1PAR1ED_I"; yName = "X1PRNIMP" ; sName="time"
fileNameRoot = "Long4-" 
...
Now we have a model for the Academic variable X1PRNAPP
```{r}
# Example for Jags-Ymet-XmetSsubj-MrobustHier.R 
#------------------------------------------------------------------------------- 
# Optional generic preliminaries:
...
myData = read.csv(file="ECLSK-2011-Long.csv")
head(myData)
xName = "X1RESREL" ; x2Name = "X1HPARNT"; x3Name = "X1LANGST"; x4Name = "X1PAR1AGE"; x5Name = "X1PAR1RAC"; x6Name = "X1HTOTAL"; x7Name = "X1KAGE_R"; x8Name = "X1PAR1ED_I"; yName = "X1PRNAPP" ; sName="time"
fileNameRoot = "Long5-" 
